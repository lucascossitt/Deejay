...
module.exports = class Info extends Command{
    ...
    async run(client, message, args){
        ...
        try {
            ...
            .setColor('#000000')
            .setDescription(`Desenvolvido em JavaScript, utilizando [Discord.JS](https://www.npmjs.com/package/discord.js) para comunicação com a API do Discord e [Erela.JS](https://www.npmjs.com/package/erela.js) como wrapper para o Lavalink. Desenvolvido por ${client.users.cache.get('227457062643171338')}`)
